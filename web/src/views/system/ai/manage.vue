...
const initAgents = () => {
  agents.value = [
    ...
    },
    {
      id: '2',
      name: '直升所默认PPT',
      description: '直升所知识库与直升机理论知识自动生成PPT',
      icon: '🌀',
    ...
    },
    {
      id: '3',
      name: '直升机传动系统设计',
      description: '主减速器、传动轴、离合器等传动系统设计与分析',
      icon: '⚙️',
    ...
    },
    {
      id: '4',
      name: '直升机飞行动力学',
      description: '直升机飞行品质分析、操纵稳定性、飞行控制',
      icon: '✈️',
    ...
    },
    {
      id: '5',
      name: '直升机发动机匹配',
      description: '航空发动机选型、功率匹配、燃油经济性优化',
      icon: '🔥',
    ...
    },
    {
      id: '7',
      name: '直升机噪音控制',
      description: '旋翼噪音分析、减振降噪技术、声学设计',
      icon: '🔇',
    ...
    },
    {
      id: '8',
      name: '直升机材料科学',
      description: '复合材料应用、轻量化设计、新材料选型',
      icon: '🔬',
    ...
    },
    {
      id: '10',
      name: '直升机系统集成',
      description: '航电系统、液压系统、燃油系统集成设计',
      icon: '🔌',
    ...
    },
    {
      id: '16',
      name: '直升机飞控系统',
      description: '自动驾驶仪、稳定增益控制、飞行管理系统',
      icon: '🛞',
