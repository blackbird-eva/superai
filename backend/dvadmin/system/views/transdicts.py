    ...
    def post(self, request):
        ...
        try:
            ...
            if not text_content or not text_content.strip():
                return SuccessResponse(data={}, msg="请输入文本内容", code=400)
            ...
            if slide_count < 5 or slide_count > 30:
                return SuccessResponse(data={}, msg="幻灯片数量必须在5-30之间", code=400)
            ...
            import traceback
            traceback.print_exc()
            return SuccessResponse(data={}, msg=f"生成失败: {str(e)}", code=500)
...
class PPTFileViewSet(CustomModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if not serializer.is_valid():
            return SuccessResponse(data={}, msg=f"验证失败: {serializer.errors}", code=400)
        ...
        try:
            ...
            return SuccessResponse(data={}, msg=f"创建失败: {str(e)}", code=500)
    ...
    def update(self, request, *args, **kwargs):
        ...
        if instance.status == 'processing':
            return SuccessResponse(data={}, msg="PPT正在生成中，无法修改", code=400)
    ...
    def download(self, request, pk=None):
        ...
        try:
            ...
            if not pptfile.file_path or not pptfile.file_path.name:
                return SuccessResponse(data={}, msg="PPT文件不存在", code=404)
    ...
    def share(self, request, pk=None):
        ...
        try:
            ...
            return SuccessResponse(data={}, msg=f"生成分享链接失败: {str(e)}", code=500)
    ...
    def preview(self, request, pk=None):
        ...
        try:
            ...
            return SuccessResponse(data={}, msg=f"获取预览失败: {str(e)}", code=500)